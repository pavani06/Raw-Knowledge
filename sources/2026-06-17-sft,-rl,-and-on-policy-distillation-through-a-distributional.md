...
tags:
  - "clippings"
---
![RL distribution](https://nrehiew.github.io/blog/sft_rl_opd/images/distributions_cover.png)
...
![Starting model distribution versus dataset/SFT target: dense gray dashed arrows show uniform SFT pressure; teal arrows show useful updates toward minimal editing behavior; rust arrows show collateral pressure on syntax, reasoning, and other regions.](https://nrehiew.github.io/blog/sft_rl_opd/images/sft_distribution.svg)
...
![RL distribution](https://nrehiew.github.io/blog/sft_rl_opd/images/rl_distribution.svg)
...
![](https://nrehiew.github.io/blog/sft_rl_opd/images/opsd_token.png)
...
<table><thead><tr><th>Model</th><th>Pass@1 ↑</th><th>Norm. Levenshtein ↓</th><th>Added CC ↓</th><th>LiveCodeBench v6 ↑</th></tr></thead><tbody><tr><th colspan="5">Teachers</th></tr><tr><td>SFT</td><td>0.775</td><td>0.450</td><td>0.450</td><td>0.286</td></tr><tr><td>RL</td><td>0.792</td><td>0.063</td><td>0.206</td><td>0.320</td></tr></tbody><tbody><tr><th colspan="5">Students (OPD)</th></tr><tr><td>OPD SFT teacher</td><td><strong>0.800</strong></td><td>0.059</td><td><strong>0.206</strong></td><td>0.297</td></tr><tr><td>OPD RL teacher</td><td>0.787</td><td><strong>0.055</strong></td><td>0.228</td><td><strong>0.314</strong></td></tr></tbody></table>
...
$$
\begin{aligned}D_{K L} \left(\right. p \parallel q_{\theta} \left.\right) & = \underset{x}{\sum} p \left(x\right) log \frac{p \left(x\right)}{q_{\theta} \left(x\right)} \\ = \underset{x}{\sum} p \left(x\right) log p \left(x\right) - \underset{x}{\sum} p \left(x\right) log q_{\theta} \left(x\right) \\ = - H \left(p\right) + H \left(p , q_{\theta}\right)\end{aligned}
$$
...
![](https://nrehiew.github.io/blog/sft_rl_opd/images/toy_reverseKL.png)
...
![On policy data](https://nrehiew.github.io/blog/sft_rl_opd/images/on_policy.svg)
...
![](https://nrehiew.github.io/blog/sft_rl_opd/images/reward_entropy_plots.svg)
...
![](https://nrehiew.github.io/blog/sft_rl_opd/images/mimo_v2_flash.png)
