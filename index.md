...
- [[concepts/context-window-management|Context Window Management]] — Techniques for staying effective within a finite context window; the core of "context engineering" (6 sources)
...
- [[concepts/sub-agents|Sub-Agents]] — Delegated agents, each with its own context window; for controlling context, not roles (6 sources)
